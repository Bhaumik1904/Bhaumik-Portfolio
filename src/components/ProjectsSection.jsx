...
const projects = [
  {
    ...
    description: 'AI-powered recruitment platform that screens resumes, ranks candidates against a job description, and identifies the top 100 best-matched candidates from datasets of up to 100,000 candidates.',
    problem: 'Enterprise recruiters spend significant time manually reviewing thousands of resumes, making it difficult to identify the best candidates quickly and consistently.',
    solution: 'Built a scalable AI recruitment engine that analyzes candidate resumes against a given job description, ranks applicants using AI-powered relevance scoring, identifies the top 100 matching candidates, detects skill gaps, and generates recruiter insights. The system is designed to process datasets containing up to 100,000 candidate profiles efficiently.',
